...
STYLE = """
  @page { size: letter; margin: 0.8in 0.8in 0.8in; }
  ...
  h2 { font-family: "Helvetica Neue", Arial, sans-serif; font-size: 13pt;
       margin: 0.26in 0 0.09in; color: #1F4E79; padding-bottom: 0.04in;
  ...
  table { border-collapse: collapse; width: 100%; margin: 0.09in 0 0.13in;
          font-size: 9.5pt; break-inside: avoid; page-break-inside: avoid; }
  th, td { text-align: left; padding: 3pt 8pt 3pt 0;
  ...
  hr { border: 0; border-top: 0.5pt solid #D8DEE6; margin: 0.2in 0; }
  ...
  /* Terminal transcripts are read column-wise; wrapping or splitting one
     destroys the alignment that makes it legible. */
  pre { background: #F4F7FA; border-left: 2.5pt solid #1F4E79;
        padding: 0.09in 0.12in; margin: 0.1in 0 0.08in; overflow: hidden;
